...
<div class="col-12">
    ...
    <?php if($lesson_details['quiz_attempt'] > ($total_attemped - 1)): ?>
        <div class="row justify-content-center">
            <div class="col-md-1"></div>
            <div class="col-md-9">
                <a class="btn btn-dark" href="<?php echo site_url('user/start_quiz/'.$lesson_details['id'].'/retake'); ?>"><?php echo get_phrase('take_the_quiz_again'); ?> <i class="fas fa-chevron-right"></i></a>
            </div>
        </div>
    <?php endif; ?>
</div>