...
<?php if ($page_name == 'blog_details'):
		$title = $this->crud_model->get_blogs($blog_id)->row_array()?>
		<title><?php echo ellipsis(strip_tags(htmlspecialchars_decode($blog_details['title'])), 140); ?></title>
	<?php else: ?>
	...
	<meta name="facebook-domain-verification" content="7qtzacfou85zrr7vnpk1k5hg1e3svs" />
<!-- Google Tag Manager -->
